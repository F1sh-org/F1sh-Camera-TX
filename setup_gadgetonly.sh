...
apt install wget gstreamer1.0-tools gstreamer1.0-plugins-base gstreamer1.0-plugins-good gstreamer1.0-plugins-bad gstreamer1.0-libcamera libcamera-apps libmicrohttpd-dev libavahi-client-dev libavahi-glib-dev -y
